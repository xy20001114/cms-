...
public class Setting {
	...
	public Setting(Integer id, String site_domain, String site_name, Integer article_list_size, Integer slide_size,
	...
	public String toString() {
		return "Setting [id=" + id + ", site_domain=" + site_domain + ", site_name=" + site_name
